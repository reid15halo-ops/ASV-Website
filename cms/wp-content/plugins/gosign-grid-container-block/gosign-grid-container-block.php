<?php
/**
 * Plugin Name: Gosign - Grid Container Block
 * Plugin URI: https://www.gosign.de/
 * Description: Gosign Grid Container block to add columns
 * Author: Gosign.de
...
/**
 * GosignGridContainerBlock Class
 */
class GosignGridContainerBlock {
    ...
    public function init_options() {
        ...
        // load textdomain.
        load_plugin_textdomain( 'gosign-grid-container-block', false, basename( dirname( __FILE__ ) ) . '/languages' );
    ...
    public function enqueue_block_editor_assets() {
        ...
        // Scripts.
        wp_enqueue_script(
            'gosign-grid-block-admin-js', // Handle.
    ...
    public function enqueue_block_assets() {
        ...
        // Styles.
        wp_enqueue_style(
            'gosign-grid-block-frontend-css',
...
/**
 * Function works with the GosignGridContainerBlock class instance
 *
 * @return object GosignGridContainerBlock
 */
function GosignGridContainerBlock() {
    return GosignGridContainerBlock::instance();
}
add_action( 'plugins_loaded', 'GosignGridContainerBlock' );
