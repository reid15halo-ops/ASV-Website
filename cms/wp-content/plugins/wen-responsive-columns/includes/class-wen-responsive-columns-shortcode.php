...
class WEN_Responsive_Columns_Shortcode {
  ...
  private function sanitize_attributes( $atts ) {
    // Sanitize and validate your attributes here
    $atts['grid']  = intval( $atts['grid'] );
  ...
  public function wen_responsive_columns_shortcode_callback( $atts, $content = "" ) {
    ...
    $args = $this->sanitize_attributes( $args );
